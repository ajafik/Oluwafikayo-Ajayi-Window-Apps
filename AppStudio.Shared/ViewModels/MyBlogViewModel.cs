...
{
    public class MyBlogViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("MyBlogDetail", item);
                        });
                }
        ...
        {
            return new MyBlogDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("MyBlogList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("MyBlogDetail");
        }
    }
}
